...
| 2 | [암호구현](writeups/02_암호구현.md) | `rot={43,7,29,14}`, 검증된 scalar incumbent와 122-instruction 4-lane AVX2 후보, 7차 split/codegen/측정 안정성 진단과 255H 보수적 autotune | [`solve_02_permutation.c`](solutions/solve_02_permutation.c) |
