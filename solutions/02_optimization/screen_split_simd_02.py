...
import screen_simd_02 as common
...
CASES = {
    ...
    "splitxmm": {
        "source": "solutions/02_optimization/contest_simd_avx2_splitxmm.c",
        "cflags": ["-mavx2", "-DCH2_SIMD_INLINE", "-finline-limit=2000"],
        "audit_mode": "report-only",
    },
    "splitpair": {
        "source": "solutions/02_optimization/contest_simd_avx2_splitpair.c",
        "cflags": ["-mavx2", "-DCH2_SIMD_INLINE", "-finline-limit=2000"],
        "audit_mode": "report-only",
    },
    "splitserial": {
        "source": "solutions/02_optimization/contest_simd_avx2_splitserial.c",
        "cflags": ["-mavx2", "-DCH2_SIMD_INLINE", "-finline-limit=2000"],
        "audit_mode": "report-only",
    },
    "splitrecompute": {
        "source": "solutions/02_optimization/contest_simd_avx2_splitrecompute.c",
        "cflags": ["-mavx2", "-DCH2_SIMD_INLINE", "-finline-limit=2000"],
        "audit_mode": "report-only",
    },
}
    ...
    return {
        ...
        "reproduction": {
            "static_and_correctness": (
                ...
                "--output solutions/02_optimization/split_simd_results_02.json"
            ),
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("solutions/02_optimization/split_simd_results_02.json"),
    )
