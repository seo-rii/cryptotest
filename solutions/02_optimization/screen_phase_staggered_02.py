...
CASES = {
    ...
    "phase_staggered": {
        "source": (
            "solutions/02_optimization/contest_simd_avx2_phase_staggered.c"
        ),
        "cflags": [
            "-mavx2",
            "-mbmi2",
...
DEPENDENCIES = {
    ...
    "candidate_verifier": {
        "path": "solutions/02_optimization/verify_contest_candidate_02.c",
        "sha256": (
            "8245f1baf23fe82e1a1b22dc7c25e5e1fd5b102ca833f26d4c88342088c80b35"
        ),
    },
    "problem_archive": {
        "path": "problems/2_암호구현.zip",
        "sha256": (
...
TIMING_SOURCES = {
    ...
    "inline_asm": {
        "path": "solutions/02_optimization/contest_simd_avx2_inline_asm.c",
        "sha256": (
    ...
    return {
        ...
        "reproduction": {
            "command": (
                ...
                "--output "
                "solutions/02_optimization/phase_staggered_results_02.json"
            ),
