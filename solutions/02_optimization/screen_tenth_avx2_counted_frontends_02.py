...
DEFAULT_JSON = SCRIPT.with_name("tenth_avx2_counted_frontends_results_02.json")
...
HELPER_RELATIVE = "solutions/02_optimization/screen_avx2_pair_blocks_02.py"
HELPER_SHA256 = "ceca3c841a441c8e7f41cd07a91f25eefd7620ac2f28caef9986d6b47b45bfa4"

DEPENDENCIES = {
    "template_candidate": (
        "solutions/02_optimization/contest_simd_avx2_pair_block3_tail1.c",
        "0949c99dc62759259244b31a0c2644ddbdf0682437585c674dd6d2dbb15bc559",
    ),
    "block2_candidate": (
        "solutions/02_optimization/contest_simd_avx2_pair_block2_counted.c",
        "154b2e449296c6130bf8e108a949443fb901ac6479f4e028cbf7420d9d109c60",
    ),
    "block5_candidate": (
        "solutions/02_optimization/contest_simd_avx2_pair_block5_counted.c",
        "5e7404a3319b6efb097002d7ddc67719387fa85d85e8a01ab32ec63e9dded3b1",
    ),
    "full_inline_source": (
        "solutions/02_optimization/contest_simd_avx2_inline_asm.c",
...
def load_helper() -> Any:
    ...
    spec = importlib.util.spec_from_file_location(
        "challenge02_tenth_pair_helper", path
    )
