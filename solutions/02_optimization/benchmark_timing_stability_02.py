...
DRIVER = ROOT / "solutions" / "benchmark_02_permutation.py"
HELPER = OPT / "benchmark_timing_stability_02.c"
SCALAR = ROOT / "submissions" / "02" / "contest.c"
AVX2 = OPT / "contest_simd_avx2_lanewise.c"
HISTORICAL = {
    1: OPT / "avx2_confirm_02_cpu1.json",
    3: OPT / "avx2_confirm_02_cpu3.json",
}
...
def main() -> None:
    ...
    parser.add_argument(
        "--json", type=Path, default=OPT / "timing_stability_results_02.json"
    )
    ...
    with tempfile.TemporaryDirectory(prefix="challenge02-timing-stability-") as raw:
        temporary = Path(raw)
        ...
        report = {
            "schema_version": 1,
            "experiment": "challenge02_scalar_avx2_timing_stability",
