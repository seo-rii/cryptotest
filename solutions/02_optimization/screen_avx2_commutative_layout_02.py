...
SOURCE_RELATIVE = "solutions/02_optimization/contest_simd_avx2_inline_asm.c"
...
def build_result(args: argparse.Namespace) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(
        prefix="challenge02-avx2-commutative-layout-"
    ) as raw_temporary:
        ...
        result = {
            "schema_version": 1,
            "experiment": "challenge02_avx2_commutative_encoding_and_layout",
            "scope": {
                "question": (
...
def main() -> None:
    ...
    parser.add_argument(
        "--json",
        type=Path,
        default=HERE / "avx2_commutative_layout_results_02.json",
    )
    parser.add_argument(
        "--check",
        action="store_true",
