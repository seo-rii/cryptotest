...
AS_OF = "2026-07-23"
SCRIPT_NAME = "solutions/02_optimization/analyze_255h_instruction_model_02.py"
DEFAULT_OUTPUT = Path(__file__).with_name("instruction_model_255h_02.json")
...
LOCAL_EVIDENCE = {
    ...
    "avx2_source": {
        "path": "solutions/02_optimization/contest_simd_avx2_lanewise.c",
        "sha256": (
            "3a8273cb6f381efb30fb4e104a9741acf158307714216f2a2b2d8c1756b9d751"
        ),
    },
    "assembly_audit": {
        "path": "solutions/02_optimization/simd_results_02.json",
        "sha256": (
...
def build_report() -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        "schema_version": 2,
        "analysis": "challenge02_core_ultra_7_255h_instruction_model",
        ...
        "reproduction": {
            "generate": (
                ...
                "analyze_255h_instruction_model_02.py --output "
                "solutions/02_optimization/instruction_model_255h_02.json"
            ),
            "check": (
                "python3 solutions/02_optimization/"
                "analyze_255h_instruction_model_02.py --check "
                "solutions/02_optimization/instruction_model_255h_02.json"
            ),
            "source_verification": (
