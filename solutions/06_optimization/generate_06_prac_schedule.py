...
Examples, from the repository root::
    ...
    python3 solutions/06_optimization/generate_06_prac_schedule.py --emit-cpp

The default run also extracts ``SUBGROUP_PRAC_SCHEDULE`` from
``deep_native_06.cpp`` and rejects any byte-level drift.  It requires only the
...
def main() -> None:
    ...
    parser.add_argument(
        "--source",
        type=Path,
        default=directory / "deep_native_06.cpp",
