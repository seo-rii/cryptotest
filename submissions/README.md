...
| 2 | [`02/src/contest.c`](02/src/contest.c), [`02/report.pdf`](02/report.pdf) | 최적화 C와 제출 문서 |
...
| 4 | [`04/solve.py`](04/solve.py), [`04/report.pdf`](04/report.pdf), [`04/report.tex`](04/report.tex), [`04/flag.txt`](04/flag.txt), [`04/README.md`](04/README.md) | 발견·추출 Python, 방법론 문서와 FLAG |
| 5 | [`05/report.pdf`](05/report.pdf), [`05/report.tex`](05/report.tex), [`05/src/02_secret_s.txt`](05/src/02_secret_s.txt), [`05/src/03_state.txt`](05/src/03_state.txt), [`05/src.zip`](05/src.zip), [`05/README.md`](05/README.md) | 1페이지 방법론과 차수 오름차순 계수, BGV 복원 소스 |
