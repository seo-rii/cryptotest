...
첫 파일은 26개 shift를 모두 복호화하고 문제의 영어 기대빈도와
Pearson $\chi^2$ 값을 비교했다.
\[
...
$k=6$의 값이 압도적으로 작고 평문은 대한민국 헌법 영문본으로
시작한다. 지정 암호문 역시 shift 6으로 복호화해 요약 표의 평문을
얻었다. 첨부 \texttt{classifier.py --full-caesar-table}은 각 후보의
