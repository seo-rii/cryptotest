...
- Previous directory preserved at `cryptotest/submissions/07/src/sat_cas_explore.old`.
...
```bash
PYTHONPATH=cryptotest/submissions/07/src/sat_cas_explore \
  python3 -m unittest cryptotest/submissions/07/src/sat_cas_explore/test_sat_cas_core.py
```
...
```bash
python3 -m py_compile cryptotest/submissions/07/src/sat_cas_explore/*.py
...
```bash
python3 cryptotest/submissions/07/src/sat_cas_explore/q_gap_gateway_beam_search.py \
...
python3 cryptotest/submissions/07/src/sat_cas_explore/run_q_gap_parallel.py \
...
```bash
python3 cryptotest/submissions/07/src/sat_cas_explore/semi_programmatic_sat.py \
  --jsonl --max-cubes 1 \
...
python3 cryptotest/submissions/07/src/sat_cas_explore/branch_q_gap_coppersmith.py \
...
```bash
python3 cryptotest/submissions/07/src/try_cp_sat_limb.py \
...
```bash
python3 cryptotest/submissions/07/src/sat_cas_explore/run_q_gap_union_shards.py \
  --cube-range 150:4:0 \
  --cube-range 265:84:0 \
  --cube-range 798:32:0 \
  --cube-range 920:4:0 \
...
```bash
python3 cryptotest/submissions/07/src/sat_cas_explore/two_sided_window_coppersmith.py \
  --window 362:830 \
  --fix-p-range 150:4:0 \
...
```bash
python3 cryptotest/submissions/07/src/sat_cas_explore/run_low600_drop_loop.py \
...
```text
python3 cryptotest/submissions/07/src/solve_jm_lowlift.py \
...
```text
cryptotest/submissions/07/src/try_hensel_tail_cp_sat.py
  --free-branch-low
  --free-branch-high
```
...
```text
cryptotest/submissions/07/src/run_tail_cp_sat_edge_sweep.py
```
...
```text
cryptotest/submissions/07/src/sat_cas_explore/rank_q_gap_assumption_pairs.py
cryptotest/submissions/07/src/sat_cas_explore/run_ranked_q_gap_hits.py
```
...
```text
cryptotest/submissions/07/src/sat_cas_explore/run_ranked_q_gap_direct.py
```
...
New generator:
  cryptotest/submissions/07/src/sat_cas_explore/make_synthetic_assumption_frontier.py
```
...
```text
cryptotest/submissions/07/src/sat_cas_explore/build_projection_frontier.py
```
...
```bash
python3 -m py_compile cryptotest/submissions/07/src/sat_cas_explore/run_fullx1x5_drop_loop.py
...
```bash
python3 -m py_compile cryptotest/submissions/07/src/sat_cas_explore/semi_programmatic_sat.py
PYTHONPATH=cryptotest/submissions/07/src/sat_cas_explore \
  python3 -m unittest cryptotest/submissions/07/src/sat_cas_explore/test_sat_cas_core.py
```
