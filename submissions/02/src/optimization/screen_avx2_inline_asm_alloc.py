...
BASE_RELATIVE = "submissions/02/src/optimization/contest_simd_avx2_lanewise.c"
BASE = HERE / BASE_RELATIVE.rsplit("/", 1)[-1]
BASE_SHA256 = "3a8273cb6f381efb30fb4e104a9741acf158307714216f2a2b2d8c1756b9d751"
RETAINED_RELATIVE = "submissions/02/src/optimization/contest_simd_avx2_inline_asm.c"
RETAINED = HERE / RETAINED_RELATIVE.rsplit("/", 1)[-1]
...
PRIOR_SCREEN_RELATIVE = "submissions/02/src/optimization/avx2_codegen_screen.json"
...
TIMING_SOURCES = {
    ...
    "block2": {
        "path": "submissions/02/src/optimization/contest_simd_avx2_pair_block2.c",
...
HOST_TIMING_RELATIVES = [
    "submissions/02/src/optimization/ninth_wave_timing_cpu1.json",
    "submissions/02/src/optimization/ninth_wave_timing_cpu3.json",
]
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=HERE / "avx2_inline_asm_alloc_results.json",
    )
