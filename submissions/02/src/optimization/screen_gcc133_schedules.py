...
def main() -> None:
    ...
    parser.add_argument(
        "--json",
        type=Path,
        default=Path(__file__).with_name("gcc133_schedule_screen.json"),
    )
    ...
    with tempfile.TemporaryDirectory(prefix="challenge-gcc133-schedules-") as name:
        ...
        output: dict[str, Any] = {
            "schema_version": 1,
            "experiment": "challenge_exact_gcc133_schedule_screen",
            "container": {
                "image": IMAGE,
