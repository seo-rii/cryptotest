...
def main() -> None:
    ...
    parser.add_argument(
        "--json",
        type=Path,
        default=Path("/tmp/gcc133_codegen_results.json"),
    )
    ...
    with tempfile.TemporaryDirectory(prefix="challenge-gcc133-") as directory:
        ...
        run_container(
            ...
            [
                "python3",
                "submissions/02/src/optimization/audit_inline.py",
                "--compiler",
                "gcc",
                "--objdump",
                "objdump",
        ...
        output: dict[str, Any] = {
            "schema_version": 1,
            "experiment": "challenge_exact_gcc133_codegen",
