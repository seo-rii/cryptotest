...
import screen_gcc133_schedules as schedule
...
ORDER_SOURCE = "submissions/02/src/optimization/contest_source_order_2103.c"
...
from loop_audit import audit_main_timing_loop, validate_loop_audit
out = Path("/output")
...
def main() -> None:
    ...
    parser.add_argument(
        "--json",
        type=Path,
        default=Path(__file__).with_name("gcc133_layout_screen.json"),
    )
    ...
    with tempfile.TemporaryDirectory(prefix="challenge-gcc133-layout-") as name:
        ...
        payload = {
            "schema_version": 1,
            "experiment": "challenge_gcc133_layout_and_scheduler_screen",
